...
type UsableOnBlock interface {
	...
	UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user User, ctx *UseContext) bool
}
...
type UsableOnEntity interface {
	...
	UseOnEntity(e world.Entity, w *world.Tx, user User, ctx *UseContext) bool
}
...
type Usable interface {
	...
	Use(w *world.Tx, user User, ctx *UseContext) bool
}
...
type Consumable interface {
	...
	Consume(w *world.Tx, c Consumer) Stack
}
