...
// Use ...
func (f Firework) Use(w *world.Tx, user User, ctx *UseContext) bool {
...
// UseOnBlock ...
func (f Firework) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user User, ctx *UseContext) bool {
