...
// BoneMeal ...
func (s WheatSeeds) BoneMeal(pos cube.Pos, w *world.Tx) bool {
	if s.Growth == 7 {
		return false
	}
...
// UseOnBlock ...
func (s WheatSeeds) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
...
// RandomTick ...
func (s WheatSeeds) RandomTick(pos cube.Pos, w *world.Tx, r *rand.Rand) {
	if w.Light(pos) < 8 {
