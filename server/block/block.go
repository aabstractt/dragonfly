...
type Activatable interface {
	...
	Activate(pos cube.Pos, clickedFace cube.Face, w *world.Tx, u item.User, ctx *item.UseContext) bool
}
...
type Punchable interface {
	...
	Punch(pos cube.Pos, clickedFace cube.Face, w *world.Tx, u item.User)
}
...
type EntityLander interface {
	...
	EntityLand(pos cube.Pos, w *world.Tx, e world.Entity, distance *float64)
}
...
type EntityInsider interface {
	...
	EntityInside(pos cube.Pos, w *world.Tx, e world.Entity)
}
...
func replaceableWith(w *world.Tx, pos cube.Pos, with world.Block) bool {
...
func firstReplaceable(w *world.Tx, pos cube.Pos, face cube.Face, with world.Block) (cube.Pos, cube.Face, bool) {
...
func place(w *world.Tx, pos cube.Pos, b world.Block, user item.User, ctx *item.UseContext) {
...
func (g gravityAffected) fall(b world.Block, pos cube.Pos, w *world.Tx) {
...
// dropItem ...
func dropItem(w *world.Tx, it item.Stack, pos mgl64.Vec3) {
