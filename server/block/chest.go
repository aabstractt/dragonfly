...
func (c Chest) open(w *world.Tx, pos cube.Pos) {
...
func (c Chest) close(w *world.Tx, pos cube.Pos) {
	for _, v := range w.Viewers(pos.Vec3()) {
...
func (c Chest) AddViewer(v ContainerViewer, w *world.Tx, pos cube.Pos) {
	c.viewerMu.Lock()
...
// it.
func (c Chest) RemoveViewer(v ContainerViewer, w *world.Tx, pos cube.Pos) {
	c.viewerMu.Lock()
	defer c.viewerMu.Unlock()
	if len(c.viewers) == 0 {
		return
...
// Activate ...
func (c Chest) Activate(pos cube.Pos, clickedFace cube.Face, w *world.Tx, u item.User, ctx *item.UseContext) bool {
...
// UseOnBlock ...
func (c Chest) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) (used bool) {
