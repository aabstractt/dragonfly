...
func (f Furnace) Tick(currentTick int64, pos cube.Pos, w *world.Tx) {
...
// UseOnBlock ...
func (f Furnace) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
...
// Activate ...
func (f Furnace) Activate(pos cube.Pos, clickedFace cube.Face, w *world.Tx, u item.User, ctx *item.UseContext) bool {
