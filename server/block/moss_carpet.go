...
// NeighbourUpdateTick ...
func (MossCarpet) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
...
// UseOnBlock ...
func (m MossCarpet) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) (used bool) {
