...
// RandomTick ...
func (n NetherWart) RandomTick(pos cube.Pos, w *world.Tx, r *rand.Rand) {
...
// UseOnBlock ...
func (n NetherWart) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
...
// NeighbourUpdateTick ...
func (n NetherWart) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
	if _, ok := w.Block(pos.Side(cube.FaceDown)).(SoulSand); !ok {
