...
// NeighbourUpdateTick ...
func (l Lantern) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
	if l.Hanging {
...
// UseOnBlock ...
func (l Lantern) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
