...
func tickLiquid(b world.Liquid, pos cube.Pos, w *world.Tx) {
...
func spreadOutwards(b world.Liquid, pos cube.Pos, w *world.Tx, displacer world.LiquidDisplacer) {
...
func sourceAround(b world.Liquid, pos cube.Pos, w *world.Tx) (sourcePresent bool) {
	pos.Neighbours(func(neighbour cube.Pos) {
...
func flowInto(b world.Liquid, src, pos cube.Pos, w *world.Tx, falling bool) bool {
...
func calculateLiquidPaths(b world.Liquid, pos cube.Pos, w *world.Tx, displacer world.LiquidDisplacer) []liquidPath {
...
func spreadNeighbour(b world.Liquid, src cube.Pos, w *world.Tx, node liquidNode, queue *liquidQueue) bool {
	if node.depth+3 <= 0 {
...
func canFlowInto(b world.Liquid, w *world.Tx, pos cube.Pos, sideways bool) bool {
	bl := w.Block(pos)
	if _, air := bl.(Air); air {
