...
// SideClosed ...
func (EnchantingTable) SideClosed(cube.Pos, cube.Pos, *world.Txn) bool {
	return false
}
...
// Activate ...
func (EnchantingTable) Activate(pos cube.Pos, clickedFace cube.Face, w *world.Txn, u item.User, ctx *item.UseContext) bool {
