...
// SideClosed ...
func (Chain) SideClosed(cube.Pos, cube.Pos, *world.Txn) bool {
	return false
}

// UseOnBlock ...
func (c Chain) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Txn, user item.User, ctx *item.UseContext) (used bool) {
