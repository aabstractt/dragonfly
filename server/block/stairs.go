...
// when needed.
func (s Stairs) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Txn, user item.User, ctx *item.UseContext) (used bool) {
...
// SideClosed ...
func (s Stairs) SideClosed(pos, side cube.Pos, w *world.Txn) bool {
