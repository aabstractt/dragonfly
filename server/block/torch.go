...
// UseOnBlock ...
func (t Torch) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
...
// NeighbourUpdateTick ...
func (t Torch) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
