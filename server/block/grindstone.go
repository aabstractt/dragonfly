...
// Activate ...
func (g Grindstone) Activate(pos cube.Pos, clickedFace cube.Face, w *world.Tx, u item.User, ctx *item.UseContext) bool {
...
// UseOnBlock ...
func (g Grindstone) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) (used bool) {
...
// NeighbourUpdateTick ...
func (g Grindstone) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
