...
// Activate ...
func (Anvil) Activate(pos cube.Pos, _ cube.Face, _ *world.Tx, u item.User, _ *item.UseContext) bool {
...
// UseOnBlock ...
func (a Anvil) UseOnBlock(pos cube.Pos, face cube.Face, _ mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) (used bool) {
...
// NeighbourUpdateTick ...
func (a Anvil) NeighbourUpdateTick(pos, _ cube.Pos, w *world.Tx) {
	a.fall(a, pos, w)
}
...
func (Anvil) Landed(w *world.Tx, pos cube.Pos) {
