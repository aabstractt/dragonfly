...
// NeighbourUpdateTick ...
func (d DoubleTallGrass) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
	if d.UpperPart {
...
// UseOnBlock ...
func (d DoubleTallGrass) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
