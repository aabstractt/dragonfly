...
// EntityLand ...
func (h HayBale) EntityLand(pos cube.Pos, w *world.Tx, e world.Entity, distance *float64) {
...
// UseOnBlock ...
func (h HayBale) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) (used bool) {
