...
// canSurvive ...
func (SeaPickle) canSurvive(pos cube.Pos, w *world.Tx) bool {
...
// BoneMeal ...
func (s SeaPickle) BoneMeal(pos cube.Pos, w *world.Tx) bool {
	if s.Dead {
		return false
	}
...
// UseOnBlock ...
func (s SeaPickle) UseOnBlock(pos cube.Pos, face cube.Face, clickPos mgl64.Vec3, w *world.Tx, user item.User, ctx *item.UseContext) bool {
...
// NeighbourUpdateTick ...
func (s SeaPickle) NeighbourUpdateTick(pos, changedNeighbour cube.Pos, w *world.Tx) {
	if !s.canSurvive(pos, w) {
